            ...
            <div class="mb-6 items-center" >
                ...
                <!--Seleccion de Area-->
                    <div class="flex space-x-3 items-center">
                        <label class="w-80 text-sm font-medium text-gray-900">Área:</label>
                        <div class="flex items-center gap-2 w-full">
                            ...
                            <span wire:loading wire:target="areaFilter" class="text-gray-500">
